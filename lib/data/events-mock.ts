...
const EVENTS: ShowEvent[] = [
  ...
  // Two same-day Simply Books fixtures so the Daily Briefing's two-column
  // view has something in both columns in mock mode.
  {
    id: "ev-bookclub", name: "Saturday Reads — Small Things Like These", leadTitle: "Small Things Like These", isbn: "9780571368700",
    date: daysFromNow(0), time: "10:30", venueId: "ven-simply", venueName: "Simply Books — Bramhall",
    hostId: "host-inhouse", hostName: "In-house (Ben)",
    types: ["Book club"], ages: [],
    format: "This month's pick is Claire Keegan's \"Small Things Like These\". New members always welcome — spare copies behind the till.",
    status: "Confirmed", fromPitchId: null,
    roles: [role("during", "Club lead", [S("karen")])],
    schedule: [step("10:15", "pre", "Reading room set-up", "karen", "12 booked. Coffee pot on.")],
    legacyStaffing: ["Karen"],
    ...
    notes: "12 booked in the reading room.",
    createdAt: "2026-07-01T10:00:00.000Z",
  },
  {
    id: "ev-storytime", name: "Toddler Story Time", leadTitle: "", isbn: "",
    date: daysFromNow(0), time: "14:00", venueId: "ven-simply", venueName: "Simply Books — Bramhall",
    hostId: "host-inhouse", hostName: "In-house (Ben)",
    types: ["Kids class"], ages: ["Under 5s"],
    format: "Rhymes and picture books for under-5s. Free, no booking needed — expect a busy kids corner from 1.45.",
    status: "Confirmed", fromPitchId: null,
    roles: [role("during", "Storyteller", [S("jess")])],
    schedule: [],
    legacyStaffing: ["Jess"],
    bookTicket: 0, ticketOnly: 0, minOrder: 0, lumaLink: "", banners: false,
    callSheet: [], callSheetSent: false, salesReportSent: false, mediaCount: 0,
