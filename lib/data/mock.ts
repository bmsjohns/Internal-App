...
const seedOrders = (): Order[] => [
  ...
  { id: "ordA8", bookTitle: "Wild Dark Shore", author: "Charlotte McConaghy", isbn: "9781399726181", customerIds: ["cusA5"], teamMember: "Holly", paid: "Not Paid", status: "Not Ordered", specialOrder: true, isPreorder: false, preorderPublicationDate: null, estimatedLeadTime: null, deliveryMethod: "Collection", location: "Prologue", notes: "", orderDate: daysAgo(0, 3), lastModified: daysAgo(0, 3) },
];
...
type Store = { orders: Order[]; customers: Customer[]; seq: number };
const g = globalThis as typeof globalThis & { __orderBookMock?: Store };
if (!g.__orderBookMock) {
  const store: Store = { orders: seedOrders(), customers: seedCustomers(), seq: 100 };
...
const { orders, customers } = g.__orderBookMock;
